...
class ConnectionLimitRedisService : public brpc::RedisService {
public:
    std::unique_ptr<brpc::ConnectionContext> NewConnectionContext(
        brpc::Socket*) const override {
        return std::unique_ptr<brpc::ConnectionContext>(
            new brpc::ConnectionContext);
    }

    brpc::RedisCommandHandlerResult DispatchCommand(
        brpc::ConnectionContext*,
